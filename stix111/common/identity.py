...
from stix111.bindings.stix_common import IdentityType
...
class Identity(stix111.Entity):
    ...
    related_identities = fields.TypedField("Related_Identities", type_="stix111.common.identity.RelatedIdentities")
