...
class AffectedAsset(stix111.Entity):
    ...
    nature_of_security_effect = fields.TypedField("Nature_Of_Security_Effect", type_="stix111.incident.affected_asset.NatureOfSecurityEffect")
    structured_description = fields.TypedField("Structured_Description", Observables)
    type_ = fields.TypedField("Type", type_="stix111.incident.affected_asset.AssetType", key_name="type")
