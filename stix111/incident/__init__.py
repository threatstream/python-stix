...
from stix111.common import Statement, VocabString, InformationSource, Confidence
from stix111.common.vocabs import VocabField
from stix111.common.statement import StatementField
from stix111.common.identity import Identity, IdentityFactory
from stix111.common.related import (GenericRelationshipList, RelatedIndicator,
...
class Incident(stix111.BaseCoreComponent):
    ...
    attributed_threat_actors = fields.TypedField("Attributed_Threat_Actors", type_="stix111.incident.AttributedThreatActors")
    related_indicators = fields.TypedField("Related_Indicators", type_="stix111.incident.RelatedIndicators")
    related_observables = fields.TypedField("Related_Observables", type_="stix111.incident.RelatedObservables")
    related_incidents = fields.TypedField("Related_Incidents", type_="stix111.incident.RelatedIncidents")
    related_packages = fields.TypedField("Related_Packages", RelatedPackageRefs)
    affected_assets = fields.TypedField("Affected_Assets", type_="stix111.incident.AffectedAssets")
    categories = fields.TypedField("Categories", type_="stix111.incident.IncidentCategories")
    ...
    leveraged_ttps = fields.TypedField("Leveraged_TTPs", type_="stix111.incident.LeveragedTTPs")
