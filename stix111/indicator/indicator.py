...
# internal
import stix111
from stix111.common.identity import Identity
from stix111.common import (InformationSource, VocabString, Confidence, RelatedTTP,
    Statement, CampaignRef)
from stix111.common.related import (GenericRelationshipList, RelatedCOA,
    RelatedIndicator, RelatedCampaignRef, RelatedPackageRefs)
from stix111.common.vocabs import VocabField, IndicatorType
...
class Indicator(stix111.BaseCoreComponent):
    ...
    composite_indicator_expression = fields.TypedField("Composite_Indicator_Expression", "stix111.indicator.CompositeIndicatorExpression")
    ...
    related_campaigns = fields.TypedField("Related_Campaigns", type_="stix111.indicator.RelatedCampaignRefs")
