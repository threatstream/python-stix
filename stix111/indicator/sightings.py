...
from stix111.common import (GenericRelationshipList, RelatedObservable,
    StructuredText, Confidence, InformationSource)
from stix111.common.datetimewithprecision import validate_precision
...
class Sighting(stix111.Entity):
    ...
    related_observables = fields.TypedField("Related_Observables", type_="stix111.indicator.sightings.RelatedObservables")
